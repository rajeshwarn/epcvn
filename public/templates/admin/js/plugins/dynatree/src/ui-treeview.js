        ...
        $("#tree").dynatree({
			...
			onSelect: function (select, node) {
                ...
                var selKeys = $.map(selNodes, function (node) {   
                	checkboxs += '<label class="checkbox-inline"><input type="checkbox" name="categoryPath[]" checked value="'+ node.data.key + '" >'+ node.data.title+'</label>';
                    //return "[" + node.data.key + "]: '" + node.data.title + "'";
                });
                
                $("#list-selected").html(checkboxs);
                //$("#list-selected").text(selKeys.join(", "));
            },
