...
class Admin_CategoryArticleController extends My_Controller_Action {
    ...
    public function init() {
        ...
        $this->_model = new Admin_Model_CategoryArticle();
    ...
    public function showAllAction() {
        $category = $this->_model->getCategoryArticleInfo();
    ...
    public function addAction() {
        ...
        $form = new Admin_Form_CategoryArticle();
        ...
        if ($this->_request->isPost()) {
            //$valid = new Admin_Form_Validators_CategoryArticleValid($data);
    ...
    public function editAction() {
        ...
        if ($this->_request->isPost()) {
            ...
            $data = $this->_model->getCategoryArticleOne($categoryId);
        }
    ...
    function ajaxEditCategoryArticleAction() {
        $template_path = TEMPLATE_PATH . "/admin";
    ...
    function ajaxRemoveCategoryArticleAction() {
        $template_path = TEMPLATE_PATH . "/admin";
        $this->loadTemplate($template_path, 'template.ini', 'ajax');
        $this->_helper->viewRenderer->setNoRender();
        ...
        if($actionName == 'REMOVE_ROW'){
	        ...
	        $parents = $this->_model->getCategoryArticles($categoryId, array('task'=>'by-parent'));
    ...
    function ajaxDeleteCategoryArticleAction() {
    	$template_path = TEMPLATE_PATH . "/admin";
    	$this->loadTemplate($template_path, 'template.ini', 'ajax');
    	$this->_helper->viewRenderer->setNoRender();
    	...
    	if($actionName == 'REMOVE_ROW'){
    		...
    		$this->_model->deleteItem('', array('task' => 'remove-all'));
    	}
    ...
    public function ajaxGetCategoryArticleAction() {
     ...
     */
    public function ajaxGetCategoryArticleProductAction() {
    	$this->_helper->layout()->setLayout('ajax');
    	$parentId = $this->_request->getParam('id', null);
    	$categorys = null;
     ...
     * get all category
     */
    public function ajaxGetAllCategoryArticleAction() {
    	$this->_helper->layout()->setLayout('ajax');
    	
    	$categoryPath = explode(',', $this->_request->getParam('categoryPath', null));
    	$categorys = $this->_model->getCategoryArticles();    	
    ...
    public function trashAction(){
    	$category = $this->_model->getCategoryArticleInfo('', array('task'=>'trash'));
